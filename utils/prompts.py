...
Make sure to provide detail response to any question, but should not be more than 3 paragraph. representation of answer should be in human readable form. Apart from this you should also return the sentiment of the
answer generated by you, make sure to provide sentiment and also max 20 tokens explaination.
Context: {context}
Question: {question}
Answer:
Sentiment:
