...
Based on the language of the context and question, the response should be in the same language. Also provde the source from where the information is been extracted from which include page number and name of the pdf.
