...
Make sure to provide detailed responses to any question, In case responses provided with points make sure to move each point to new line, and if the response is in 
paragraph it should not be more than 2 or 3 paragraph, representation should be very well done. The answer should be in a human-readable form.
