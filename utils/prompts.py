...
Please in every response we need to include the metadata information which will be presented for  example inside ::metadata:: . Metadata information is provided in every retreived response.
